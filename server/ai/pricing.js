...
const PRICES = {
  ...
  "openai/gpt-oss-120b":         { input: 0.037 / 1e6, output: 0.17 / 1e6 },
  "openai/gpt-4o-mini":          { input: 0.15 / 1e6, output: 0.60 / 1e6 },
  "openai/gpt-4o":               { input: 5.00 / 1e6, output: 15.00 / 1e6 },
  // Google via OpenRouter
  "google/gemma-4-26b-a4b-it":   { input: 0.10 / 1e6, output: 0.30 / 1e6 },
  "google/gemma-4-31b-it":       { input: 0.22 / 1e6, output: 0.55 / 1e6 },
  "google/gemini-flash-1.5":     { input: 0.075 / 1e6, output: 0.30 / 1e6 },
  "google/gemini-2.5-flash":     { input: 0.15 / 1e6, output: 0.60 / 1e6 },
  // Z.AI + DeepSeek via OpenRouter (paid-tier models)
  "z-ai/glm-4.6":                { input: 0.50 / 1e6, output: 2.00 / 1e6 },
  "deepseek/deepseek-chat-v3.1": { input: 0.25 / 1e6, output: 0.95 / 1e6 },
