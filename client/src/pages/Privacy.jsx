  ...
  return (
    <LegalDoc title="Privacy Policy" updated="11 July 2026">
      ...
      <Section title="What we collect">
        ...
        <p><strong className="text-foreground">Practice data:</strong> every question you answer, the option you select, whether you skip, timing, and — if you write it — your typed reasoning explaining your answer. In AI Coach, this also includes your reading-map notes and the back-and-forth of your Socratic debrief conversation.</p>
        ...
        <p><strong className="text-foreground">Technical data:</strong> IP address and request metadata, collected briefly for rate-limiting and abuse prevention (blocking scripted login attempts, for example) — not used to build an advertising profile of you.</p>
      ...
      <Section title="How your reasoning text and Coach content is used">
        <p>
      ...
      <Section title="Children's data">
        <p>
          ...
          and we don't run behavioural tracking or targeted advertising toward minors. If you
